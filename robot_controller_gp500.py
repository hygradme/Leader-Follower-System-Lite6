...
class RobotContorllerGP500:
    ...
    def move_robot_joint(self, joints, is_radian=True):
        ...
        act_target_angles = self._apply_filter(act_target_angles)
        # self.check_safety(act_target_angles)
        self.arm.set_servo_angle_j(angles=act_target_angles, is_radian=is_radian)  #, speed=100)#, wait=False)
